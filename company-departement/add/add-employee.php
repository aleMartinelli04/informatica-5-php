        ...
        <div class="container">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (!$firstName || !$lastName || !$departement) {
                    ...
                    DBCompany::run("INSERT INTO employee(id, firstName, lastName, departement_id) VALUES (DEFAULT, ?, ?, ?)",
                        $firstName, $lastName, $departement);

                    echo "<h4>Dipendente aggiunto con successo!</h4>";
                }
            }
            ?>
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="departement" name="departement" required>
                        <option selected disabled value="">Seleziona un dipartimento</option>
                ...
                <div>
                    <button class="btn btn-ok" type="submit" name="submit" id="submit">Aggiungi dipendente</button>
